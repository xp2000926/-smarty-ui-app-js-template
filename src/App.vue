...
<template>
  <div>
    ...
    <a href="https://vuejs.org/" target="_blank">
      <img src="./assets/smarty.svg" class="logo vue MinSmartyUI" alt="Vue logo" />
    </a>
  </div>
  <HelloWorld msg="MinSmartyUI + Vite + Vue" />
...
.logo.vue.MinSmartyUI{
  filter: drop-shadow(0 0 0.3em #000000ff);
}
</style>
